...
using MVCSQLServer.Services.Implements;
...
builder.Services.AddDbContext<ContextDatabase>
	(options => options.UseSqlServer("Server=CORA-PC\\SQLEXPRESS;Database=GamesList;User Id=sa;Password=admin;TrustServerCertificate=True;"));
